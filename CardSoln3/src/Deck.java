...
public class Deck {
    ...
    /**
     * This is for part 3 of exercise 5
     * It deals 5 cards, without replacement, to a PokerHand
     * @return
     */
    public PokerHand deal(int n)
    {
    	PokerHand result = new PokerHand();
    	result.cards = this.subdeck(0, n-1).cards;
    	this.cards = this.subdeck(n,this.cards.length-1).cards;
    	return result;
    }
}